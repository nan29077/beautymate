    ...
    try {
      const res = await fetch("/api/seller/campaigns", {
        ...
        body: JSON.stringify({
          ...
          title: campaign.title || `${selectedProduct.name} 단체 상담`,
  ...
  return (
    <>
      <button onClick={() => setShowForm(true)} className="btn-primary text-sm !px-3 !py-2 sm:!px-4 sm:!py-2.5 whitespace-nowrap">
        ...
        <span className="hidden sm:inline">단체 상담 등록</span><span className="sm:hidden">공구</span>
      </button>
          ...
          <div className="bg-white w-full h-full sm:h-auto sm:max-h-[90vh] sm:rounded-2xl sm:shadow-2xl sm:max-w-lg flex flex-col overflow-y-auto">
            ...
            <div className="p-5 max-h-[65vh] overflow-y-auto">
              {step === "select" && (
                <div className="space-y-4">
                  <div className="bg-brand-50 rounded-xl p-3 mb-2">
                    <p className="text-xs text-brand-600">내 상담상품 또는 브랜드/관리자가 단체 상담으로 등록한 상담상품을 선택하세요.</p>
                  </div>
              ...
              {step === "config" && selectedProduct && (
                <div className="space-y-4">
                  ...
                  {/* Price */}
                  <div>
                    <label className="text-sm font-medium text-gray-700">단체 상담 가격 *</label>
                    <input
                  ...
                  <div className="grid grid-cols-2 gap-3">
                    <div>
                      <label className="text-sm font-medium text-gray-700">최소 예약 수량</label>
                      <input
                    ...
                    <div>
                      <label className="text-sm font-medium text-gray-700">최대 예약 수량</label>
                      <input
                  ...
                  {/* Estimated Delivery */}
                  <div>
                    <label className="text-sm font-medium text-gray-700">예상 상담일</label>
                    <input
                  ...
                  {/* Description */}
                  <div>
                    <label className="text-sm font-medium text-gray-700">단체 상담 설명</label>
                    <textarea
                      className="input-field mt-1 h-20 resize-none text-sm" placeholder="단체 상담에 대한 추가 설명..."
            ...
            {step === "config" && (
              <div className="flex gap-2 px-5 py-4 border-t border-gray-100">
                <button onClick={() => setStep("select")} className="btn-outline flex-1 py-2.5">← 상담상품 변경</button>
                <button
