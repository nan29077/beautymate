              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-xs text-gray-500 mt-0.5">
                    인증 완료 시 해당 점집의 모든 상담상품을 <span className="text-brand-600 font-semibold">할인된 가격</span>으로 구매할 수 있어요!
                  </p>
                </div>
              </div>
            </div>
              ...
              <div className={`mb-3 rounded-xl p-3 text-center ${
                ...
                {ocrResult.verified ? (
                  ...
                  <>
                    ...
                    <p className="text-[10px] text-yellow-600 mt-0.5">자동 확인이 어려워 상담사/관리자가 직접 확인합니다.</p>
