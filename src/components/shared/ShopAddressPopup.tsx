        ...
        <div className="relative bg-gradient-to-br from-amber-400 to-amber-500 px-5 py-4">
          ...
          <div className="flex items-center gap-2 text-white">
            ...
            <div>
              ...
              <p className="text-[11px] text-white/80 flex items-center gap-1"><Hexagon size={11} strokeWidth={1.5} /> 라이브 점집 방문을 환영합니다</p>
            </div>
          </div>
        </div>
          ...
          {address ? (
            <>
              ...
              <label className="flex items-start gap-2.5 px-1 mb-4 cursor-pointer select-none">
                ...
                <span className="text-[12px] text-gray-600 leading-snug">
                  판매자 알림 정보를 받고 싶으십니까?
                  <span className="block text-[11px] text-gray-400">라이브·단체 상담 등 상담사 소식을 알림톡으로 받아요</span>
                </span>
              </label>
            ...
            <>
              <div className="bg-amber-50 border border-amber-100 rounded-xl px-4 py-3 mb-4">
                ...
                <p className="text-[11px] text-amber-700/80 mt-0.5">
                  지금 입력하지 않으면 예약 시 결제 창에서 입력하실 수 있습니다.
                </p>
              </div>
