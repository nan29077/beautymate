...
// 예약자 연락처 입력 폼.
// 뷰티메이트 시절의 배송지 입력(ShippingForm — 우편번호/주소/상세주소/배송메모, 저장된 배송지 목록)을
// 대체한다. 라이브 뷰티 상담는 배송이 없으므로 상담 안내를 받을 이름·연락처와 요청사항만 받는다.
  ...
  return (
    <div className="bg-white rounded-xl border border-gray-100 p-4">
      ...
      <div className="space-y-3">
        ...
        <div>
          <label className="text-xs text-gray-500 flex items-center gap-1 mb-1">
            <Icon name="File" size={12} /> 뷰티 전문가에게 남길 요청사항
          </label>
          <input
            type="text"
            value={value.memo}
