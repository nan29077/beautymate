...
import { Target, Loader2, Gift, Ticket, Wind, Star } from 'lucide-react';
...
export default function GameJoinClient({
  ...
  const renderDone = () => {
    if (isBox && boxResult) {
      ...
      const Icon = KIND_ICON[boxResult.kind] || Star;
      return (
    ...
    <div className="min-h-[100dvh] flex flex-col items-center justify-center px-5 py-10">
      <div className="w-full max-w-sm">
        ...
        <header className="mb-5 flex flex-col items-center rounded-2xl bg-white border border-amber-100 py-4 px-6">
          ...
          <span className="text-[15px] font-extrabold tracking-tight text-[#2d1b69]">사주메이트 GAMES</span>
