...
import { Gamepad2, X, Disc3, Network, Ticket, Settings2, Zap, Hash, HelpCircle, BarChart3, Target, Star, ListOrdered, Monitor, Trophy } from 'lucide-react';
import {
                  ...
                  <div className="flex items-center gap-2.5 min-w-0">
                    ...
                    <div className="min-w-0">
                      ...
                      {usesParticipants(g.type) ? (
                        ...
                        <span className="inline-block mt-0.5 text-[10px] bg-gray-100 text-gray-400 px-1.5 py-0.5 rounded-full font-semibold">상담사 진행</span>
                      )}
                    </div>
                  </div>
            ...
            <div className="p-5 space-y-4">
              ...
              <div className="rounded-xl border border-gray-100 bg-gray-50 p-4">
                ...
                <div className="space-y-2 text-[12px] text-gray-600 leading-relaxed">
                  <p><span className="font-semibold text-gray-700">진행자(상담사):</span> 게임을 생성한 후 라이브 방송 중 컨트롤 패널에서 게임을 시작하세요. 오버레이 URL을 OBS/프리즘 브라우저 소스에 연결하면 방송 화면에 게임이 표시됩니다.</p>
