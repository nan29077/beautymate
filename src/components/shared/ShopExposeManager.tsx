    ...
    <div className="bg-white rounded-xl border border-gray-100 p-4 mb-5">
      ...
      <div className="flex items-center justify-between gap-3">
        <div className="flex items-start gap-2.5">
          ...
          <div>
            <p className="text-sm font-bold text-gray-900">점집에 바로 노출하기</p>
            <p className="text-[11px] text-gray-500 mt-0.5 leading-relaxed">
              ON: 라이브 방송 없이 등록한 상담상품을 라이브 점집에 바로 노출합니다.<br />
              OFF: 기존처럼 라이브 방송을 생성해야 라이브 점집에 노출됩니다.
            </p>
          </div>
        </div>
        ...
        <div className="mt-4 pt-4 border-t border-gray-50">
          <div className="flex items-center justify-between gap-3">
            <div className="flex items-start gap-2.5">
              ...
              <div>
                <p className="text-sm font-bold text-gray-900">상담상품 번호 매기기</p>
                <p className="text-[11px] text-gray-500 mt-0.5 leading-relaxed">
                  ON: 판매중 상담상품에 번호를 매겨 라이브 점집에 번호와 함께 노출합니다. (중복 번호 불가)
                </p>
              </div>
            </div>
          ...
          {numbering && (
            <div className="mt-3">
              ...
              <div className="space-y-1.5 max-h-72 overflow-y-auto pr-1">
                {products.length === 0 ? (
                  <p className="text-[11px] text-gray-400 text-center py-3">판매중인 상담상품이 없습니다.</p>
                ) : products.map((p) => {
