...
const FAQS = [
  { q: "사주메이트는 어떤 서비스인가요?", a: "브랜드의 좋은 상담상품을 신뢰하는 상담사(인플루언서)를 통해 만나는 단골 중심 커머스예요. 좋아하는 상담사를 PICK하고, 그 상담사만의 점집과 라이브를 즐길 수 있어요." },
  { q: "다른 상담사는 어떻게 찾나요?", a: "메인 상단의 검색창에서 상담사 이름이나 라이브 코드로 검색하면 돼요. 사주메이트는 아무나 둘러보는 곳이 아니라, 내가 아는·좋아하는 상담사와 깊게 연결되는 단골형 서비스예요." },
  { q: "PICK은 무엇인가요?", a: "마음에 드는 상담사를 단골로 등록하는 기능이에요. PICK하면 그 상담사의 라이브 시작·새 소식 알림을 받고, 전용 점집에서 편하게 상담을 예약할 수 있어요." },
  { q: "라이브 방송은 어떻게 보나요?", a: "PICK한 상담사가 방송을 시작하면 알림이 와요. 메인의 '라이브 찾기'에서 상담사 이름이나 라이브 코드로 검색해 입장할 수도 있어요." },
  { q: "상담사로 활동하려면 어떻게 하나요?", a: "메인의 '상담사로 신청하기' 버튼에서 신청할 수 있어요. 입점·가입 비용은 없고, 브랜드 상담상품을 골라 판매하면 커미션을 받는 구조예요." },
