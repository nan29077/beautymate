...
const FAQS = [
  { q: "사주나라는 어떤 서비스인가요?", a: "좋은 상담상품을 신뢰하는 상담사를 통해 만나는 단골 중심 상담 플랫폼이에요. 좋아하는 상담사를 단골로 설정하고, 그 상담사만의 점집과 라이브를 즐길 수 있어요." },
  { q: "다른 상담사는 어떻게 찾나요?", a: "메인 상단의 검색창에서 상담사 이름이나 라이브 코드로 검색하면 돼요. 사주나라는 아무나 둘러보는 곳이 아니라, 내가 아는·좋아하는 상담사와 깊게 연결되는 단골형 서비스예요." },
  ...
  { q: "상담사로 활동하려면 어떻게 하나요?", a: "메인의 '상담사로 신청하기' 버튼에서 신청할 수 있어요. 입점 비용 등 조건은 상담 후 결정되며, 단골 고객관리(CRM)와 상담 내용 AI 요약 기능도 제공돼요." },
  { q: "결제·상담 방식·환불은 안전한가요?", a: "사주나라는 통신판매중개자로서 안전한 거래 시스템을 제공해요. 예약·상담 방식 현황은 마이페이지에서 확인할 수 있고, 알림으로도 안내해 드려요." },
];
