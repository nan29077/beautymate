...
// 뷰티 전문가 서브페이지(/cart, /my/* ...)에서 뷰티 전문가 전용 상단 헤더를 렌더한다.
// 뷰티 전문가 컨텍스트가 없거나 일반 경로면 아무것도 렌더하지 않는다(공통 Header 가 그대로 노출됨).
...
// 뷰티 전문가 서브페이지에서 뷰티 전문가 전용 하단 네비를 렌더한다(공통 MobileNav 는 숨겨짐).
