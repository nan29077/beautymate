    ...
    <div className="space-y-5">
      <div className="flex items-start justify-between gap-3">
        <div className="min-w-0">
          <h1 className="text-lg sm:text-xl font-bold text-gray-900">패키지 상담상품 관리</h1>
      ...
      <div className="bg-amber-50 border border-amber-100 rounded-xl p-3.5 text-[12px] text-amber-700 leading-relaxed">
        소속 브랜드가 등록한 패키지 상담상품에 <b>마진</b>을 설정하고 <b>판매가</b>를 조정할 수 있습니다.
      ...
      {filtered.length === 0 ? (
        <div className="text-center py-20 text-gray-400 bg-white rounded-xl border border-gray-100">
          <Star size={48} strokeWidth={1.5} className="mx-auto mb-3 opacity-30" />
          <p className="text-sm">표시할 패키지 상담상품이 없습니다.</p>
          <p className="text-xs mt-1 text-gray-300">우측 상단 버튼으로 패키지 상담상품을 등록해보세요.</p>
        </div>
      ) : (
