  ...
  return (
    <div className="animate-fade-in space-y-6 max-w-4xl">
      ...
      <DashboardPageHeader
        ...
        title="예약 현황"
        description={`${shopName} · ${status?.date ?? localToday()} · 30초마다 자동 갱신`}
        actions={<>
          <button
          ...
          <button
            ...
            className="flex items-center gap-1.5 px-3.5 py-2 rounded-xl bg-brand-600 text-white text-sm font-semibold shadow-[0_7px_18px_rgba(104,73,216,0.2)] hover:bg-brand-700"
          >
