...
import { Building2, Save, Loader2, Briefcase, Phone, FileText, X, Share2, Lock, Bell } from 'lucide-react';
...
export default function SettingsClient() {
  ...
  const notiList = [
    { key: "order" as const, label: "예약 알림", desc: "새 예약 및 예약 상태 변경" },
    { key: "inquiry" as const, label: "문의 알림", desc: "팬/고객 문의 수신" },
          ...
          <div className="space-y-5">
            ...
            <div className="bg-blue-50 rounded-xl p-3">
              <p className="text-[11px] text-blue-700">
                정산 대금을 받을 계좌입니다. 계좌 입금 예약서에 표시되어 고객이 입금할 수 있습니다.
              </p>
            </div>
            <div>
