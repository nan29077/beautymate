...
interface Props {
  totals: { totalSales: number; pendingTotal: number; availableTotal: number; requestedTotal: number; sellerbricksRevenue: number; businessDays: number };
  payouts: Payout[];
}
  ...
  return (
    <div className="animate-fade-in">
      ...
      <div className="grid grid-cols-2 lg:grid-cols-5 gap-3 mb-5">
        ...
        <SummaryCard icon={<PiggyBank size={16} className="text-brand-600" />} label="사주메이트 수익 (판매가 기준, PG 2.86% 제외)" value={won(totals.sellerbricksRevenue)} tone="bg-brand-50" />
      </div>
