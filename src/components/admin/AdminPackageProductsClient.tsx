...
import { Star, Check, X, Eye, Clock, ChevronDown, ChevronUp, BookOpen } from "lucide-react";
    ...
    <div>
      ...
      {filtered.length === 0 ? (
        <div className="py-16 text-center bg-white rounded-xl border border-gray-100">
          <Star size={40} className="mx-auto mb-3 opacity-30 text-gray-400" />
          <p className="text-sm text-gray-400">패키지 상담상품이 없습니다.</p>
        </div>
      ) : (
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div className="w-14 h-14 rounded-lg overflow-hidden bg-gray-100 flex-shrink-0">
                      {pkg.imageUrl ? (
                        ...
                        <Star size={24} className="m-auto mt-4 text-gray-300" />
                      )}
                    </div>
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <div className="flex items-center gap-3 text-xs text-gray-500 flex-wrap">
                        ...
                        <span>예약수: {pkg._count.packageOrderItems}</span>
                      </div>
                      {pkg.rejectReason && (
                ...
                {isExpanded && (
                  <div className="px-4 pb-4 border-t border-gray-100 pt-3">
                    <div className="flex items-center justify-between mb-2">
                      <p className="text-xs font-bold text-gray-700">구성 상담상품 상세</p>
                          ...
                          <div className="flex items-center gap-3">
                            <div className="w-10 h-10 rounded-md overflow-hidden bg-gray-200 flex-shrink-0">
                              {item.product.thumbnail ? (
                                ...
                                <Star size={16} className="m-auto mt-3 text-gray-400" />
                              )}
                            </div>
                            <div className="flex-1 min-w-0">
