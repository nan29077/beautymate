...
2. 상담상품 불량 또는 오배송 수령 후 7일 이내 고객센터로 문의해 주세요.
...
※ 법적 안내  소비자분쟁해결기준에 따라 피해보상이 이루어집니다.`,
  },
  {
    key: "shippingPolicy",
    label: "상담 방식 정책",
    placeholder: `상담 방식 안내 내용을 입력하세요.

예시:
- 상담 기간: 결제 완료 후 3~5 영업일 이내 출고
- 도서산간 지역은 추가 1~2일 소요될 수 있습니다.
- 천재지변 등 불가항력적 상황에서는 상담 방식이 지연될 수 있습니다.`,
  },
  {
    key: "usagePolicy",
    label: "이용 안내",
