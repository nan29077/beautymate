      ...
      <section className="bg-white rounded-xl border border-gray-100 p-4">
        ...
        <div className="py-3.5 border-t border-gray-100">
          ...
          <p className="text-xs text-gray-500 mt-1.5 leading-relaxed pr-14">
            노드는 중간관리자·브랜드가 등록한 상담상품에 마진을 한 번 더 설정한 뒤 최고관리자 승인 단계로 넘기는
            중간 역할입니다. <b>켜면</b> 노드 계정이 노드 대시보드(예약관리)에 접근할 수 있고, 노드로 들어온 상담상품에
            마진을 설정해 최종 등록할 수 있습니다. <b>끄면</b> 노드 대시보드 접근이 차단되고, 상담상품 흐름은 노드 단계를
            건너뛴 기존 방식(중간관리자·브랜드 → 최고관리자 승인 → 상담사 신청)으로 동작합니다.
          </p>
        </div>
        ...
        <div className="flex items-start gap-1.5 rounded-lg bg-gray-50 p-2.5 mt-1">
          ...
          <p className="text-[11px] text-gray-500 leading-relaxed">
            노드가 최종 등록한 상담상품은 이미 설정된 마진 데이터가 보존되며, 노드를 껐다 켜도 데이터는 유지됩니다.
          </p>
        </div>
      </section>
      ...
      <section className="bg-white rounded-xl border border-gray-100 p-4">
        ...
        <div className="space-y-2.5">
          <div className="flex items-center justify-between rounded-lg bg-gray-50 px-3 py-2.5">
            ...
            <span className="text-xs font-mono font-semibold text-gray-800 select-all">node@sajumate.kr</span>
          </div>
          <div className="flex items-center justify-between rounded-lg bg-gray-50 px-3 py-2.5">
            <div className="flex items-center gap-2">
