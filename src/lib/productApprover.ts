...
//
// 승인 주체 규칙:
//  1) 상담상품을 중간관리자가 직접 등록(product.middleAdminId 존재) → 중간관리자
//  2) 브랜드사 상담상품이고 그 브랜드가 중간관리자 소속(brand.middleAdminId 존재) → 중간관리자
//     (중간관리자가 마진을 더해 등록했으므로)
//  3) 브랜드사 상담상품이지만 독립 브랜드(brand.middleAdminId 없음) → 브랜드사 직접
