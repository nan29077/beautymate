/**
 * 상담사 추천인(멘토-멘티) 시스템 유틸리티
 *
 * - sellerReferralCode: User 테이블에 저장되는 상담사가입 추천인코드 (예: SB4K9M2X)
 * - 고객 레퍼럴(SellerProfile.referralCode)과 완전히 별개
 */

import type { PrismaClient } from "@/generated/prisma";

/** 상담사가입 추천인코드 생성 (SB + 6자리 영문대문자+숫자) */
