...
export const ALIMTALK_PURPOSES: Record<string, AlimtalkPurposeDef> = {
  ...
  ORDER_PLACED: {
    ...
    sampleVariables: { "셀러샵명": "테스트점집", "주문자명": "홍길동", "주문번호": "ORD-TEST-0001", "구/면": "강남구", "동/리": "역삼동", "결제금액": "10,000" },
  },
  SHIPPING_START: {
    label: "상담 시작 안내 (고객에게)",
    description: "운송장 번호가 입력되면 고객에게 상담 시작을 안내",
    variables: ["고객명", "셀러샵명", "택배발송 날짜", "송장번호"],
    sampleVariables: { "고객명": "홍길동", "셀러샵명": "테스트점집", "택배발송 날짜": "2026-07-22", "송장번호": "1234567890" },
  },
  SIGNUP_WELCOME: {
    label: "회원가입 환영 (고객에게)",
