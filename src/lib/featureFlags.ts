...
export const FEATURE_DEFAULTS: FeatureFlags = {
  ...
  themSummer: false,
  themAutumn: false,
  // 게임 관리 — 커머스 라이브 이벤트용 기능이라 사주나라에서는 기본 비활성.
...
export const FEATURE_META: {
  ...
  },
  {
    ...
    detail:
      "사주나라 브랜드 정체성을 담은 이모지·이미지 장식의 전역 노출 여부입니다. 켜면 PC 여백, 로그인, 대시보드, 각 페이지 곳곳에 장식이 표시됩니다. 끄면 앱 전반의 장식이 모두 숨겨져 담백한 화면이 됩니다. 판매·정산 등 기능 동작에는 전혀 영향을 주지 않는 순수 시각 옵션입니다.",
    group: "appearance",
  },
  {
    key: "themSnow",
