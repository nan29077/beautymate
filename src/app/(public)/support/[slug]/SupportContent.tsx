...
const FAQ_ITEMS = [
  { q: "상담 방식은 얼마나 걸리나요?", a: "결제 완료 후 영업일 기준 2~5일 이내에 도착합니다. 예약 후 상담상품이 준비되면 순차적으로 발송되며, 발송 시점에 운송장 번호가 등록되어 마이페이지 > 예약내역에서 상담 방식 조회가 가능합니다. 제주 및 도서산간 지역은 상담 방식사 사정에 따라 1~3일가량 추가로 소요될 수 있으니 참고해 주세요." },
  { q: "교환/반품은 어떻게 하나요?", a: "상담상품 수령 후 7일 이내에 마이페이지 > 예약내역에서 해당 예약을 선택하거나 1대1 문의를 통해 신청해 주세요. 단순 변심의 경우 왕복 배송비가 부과되며, 상담상품 하자·오배송의 경우 배송비 없이 무료로 처리됩니다. 상담상품을 사용·훼손했거나 세탁한 경우, 그리고 식품·위생용품 등 재판매가 어려운 상담상품은 교환·반품이 제한될 수 있으니 개봉 전에 먼저 문의해 주세요. 접수 후 회수와 처리까지는 보통 3~5 영업일이 소요됩니다." },
  ...
  { q: "구매 후 후기는 어디서 작성하나요?", a: "마이페이지 > 예약내역에서 구매 확정된 예약을 선택해 후기를 작성할 수 있습니다. 상담 방식 완료 후 일정 기간이 지나면 자동으로 구매 확정 처리되며, 사진과 함께 후기를 남기면 다른 고객에게 큰 도움이 됩니다. 작성한 후기는 마이페이지에서 언제든 수정하거나 삭제할 수 있습니다." },
];
