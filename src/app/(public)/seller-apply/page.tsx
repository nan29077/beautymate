...
const BENEFITS = [
  ...
  { icon: Radio, color: "text-rose-500", bg: "bg-rose-50", title: "라이브 뷰티", desc: "실시간 방송으로 팔로워와 소통하며 즉시 판매해요." },
  { icon: ShieldCheck, color: "text-blue-600", bg: "bg-blue-50", title: "안심 정산 시스템", desc: "복잡한 정산·진행 방식은 플랫폼이 처리해요." },
];
  ...
  return (
    <div className="min-h-screen bg-white pb-12">
      ...
      <div className="sticky top-0 z-10 bg-white border-b border-gray-100 px-4 py-3 flex items-center gap-2">
        ...
        <h1 className="text-[15px] font-bold text-gray-900">뷰티 전문가 입점신청</h1>
      </div>
      ...
      <section className="px-4 py-6">
        <h3 className="text-[14px] font-bold text-gray-900 mb-3">뷰티 전문가가 되면 이런 게 가능해요</h3>
      ...
      <section className="px-4 pb-6">
        ...
        <div className="space-y-2">
          {[
            ...
            { no: 3, title: "승인 완료", desc: "승인 후 뷰티 전문가 대시보드에서 바로 뷰티샵을 운영할 수 있어요." },
          ].map((s) => (
