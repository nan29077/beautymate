  ...
  return (
    <div className="min-h-screen bg-white pb-12">
      ...
      <div className="sticky top-0 z-10 bg-white border-b border-gray-100 px-4 py-3 flex items-center gap-2">
        ...
        <h1 className="text-[15px] font-bold text-gray-900">상담사 입점신청</h1>
      </div>
      ...
      <section className="px-4 py-6">
        <h3 className="text-[14px] font-bold text-gray-900 mb-3">상담사가 되면 이런 게 가능해요</h3>
      ...
      <section className="px-4 pb-6">
        ...
        <div className="space-y-2">
          {[
            ...
            { no: 3, title: "승인 완료", desc: "승인 후 상담사 대시보드에서 바로 점집을 운영할 수 있어요." },
          ].map((s) => (
