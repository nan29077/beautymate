...
export default async function PublicLayout({
  ...
  return (
    <ShopChromeProvider initialShop={initialShop}>
      <div className="beautymate-public-shell min-h-screen">
        <div className="beautymate-app-frame relative z-10 max-w-[480px] mx-auto bg-white min-h-screen shadow-[0_0_52px_rgba(36,20,69,0.14)] pb-[env(safe-area-inset-bottom)]">
