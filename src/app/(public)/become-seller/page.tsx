...
export const metadata = {
  title: "뷰티 전문가로 신청하기 | 뷰티메이트",
  description: "뷰티메이트 뷰티 전문가가 되어 내 팬과 함께 나만의 뷰티샵을 운영하세요.",
};
...
const BOTTOM_BANNER = "/banners/beautymate/expert-cta-v3.png";

const BENEFITS = [
  { icon: Star, title: "준비물은 실력뿐", desc: "뷰티 서비스와 가능한 시간만 등록하면 끝. 예약 접수·결제·알림은 뷰티메이트가 대신해요." },
  { icon: TrendingUp, title: "예약 수익", desc: "내 뷰티샵에서 예약이 확정될 때마다 수익이 쌓여요. 방송이 곧 매출이 돼요." },
  { icon: Gift, title: "추천 수익", desc: "내 추천 코드로 가입·예약한 팬의 매출에서도 추천 커미션이 발생해요." },
  { icon: Radio, title: "라이브 뷰티", desc: "실시간 라이브 방송으로 팬과 소통하며 그 자리에서 예약을 받을 수 있어요." },
...
const STEPS = [
  { title: "뷰티 전문가 신청", desc: "아래 버튼으로 뷰티 전문가 회원가입을 진행해요." },
  { title: "관리자 승인", desc: "보통 1~2 영업일 내 심사 후 승인돼요." },
  { title: "뷰티샵 개설 & 뷰티 서비스 등록", desc: "내 뷰티샵을 꾸미고 뷰티 서비스와 가능한 시간을 등록해요." },
  { title: "예약 & 정산", desc: "뷰티샵·라이브로 예약을 받고 수익을 정산받아요." },
];

const FAQ = [
  { q: "뷰티 전문가가 되려면 비용이 드나요?", a: "입점 비용 등 조건은 서비스 후 결정됩니다. 예약이 발생하면 약정된 수수료 구조로 정산됩니다." },
  { q: "뷰티 서비스는 어떻게 등록하나요?", a: "스킨케어·메이크업·헤어·네일·퍼스널 컬러 등 내가 제공하는 서비스를 직접 등록하고, 가능한 시간을 함께 설정하면 됩니다." },
  { q: "승인까지 얼마나 걸리나요?", a: "일반적으로 1~2 영업일 이내에 관리자 검토 후 승인됩니다." },
  { q: "팔로워(팬)가 적어도 신청할 수 있나요?", a: "네, 누구나 신청할 수 있어요. 뷰티메이트의 단골·라이브 기능으로 팬을 키워갈 수 있습니다." },
];
