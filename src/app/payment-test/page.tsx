...
//
// 사용: 로그인 후 http://localhost:3000/payment-test 진입 → "결제창 띄우기" 클릭.
// 사전 조건: 임의 예약 1개가 DB 에 있어야 함. URL ?orderId=<Order.id> 로 지정.
    ...
    <div style={{ padding: 32, fontFamily: "sans-serif", maxWidth: 720 }}>
      ...
      <div style={{ marginBottom: 16 }}>
        ...
        <p style={{ fontSize: 11, color: "#888", marginTop: 4 }}>
          URL로 전달: <code>?orderId=...</code>. 본인 소유 PENDING 예약이어야 합니다.
        </p>
      </div>
