  ...
  return (
    <div className="animate-fade-in space-y-6">
      ...
      <div className="grid grid-cols-3 gap-2 sm:gap-3">
        ...
        <div className="bg-gray-900 rounded-xl p-3 sm:p-4 text-white">
          <p className="text-gray-300 text-[9px] sm:text-[10px] font-medium mb-1">소속 상담사</p>
          <p className="text-xl sm:text-2xl font-bold">{sellerCount.toLocaleString()}</p>
          <p className="text-gray-400 text-[9px] sm:text-[10px] mt-1">관리 중인 상담사</p>
        </div>
      ...
      <div className="grid grid-cols-2 sm:grid-cols-4 gap-2 sm:gap-3">
        {[
          ...
          { label: "소속 상담사", value: sellerCount, icon: "Store", color: "text-blue-500" },
          { label: "브랜드 상담상품", value: totalProducts, icon: "Package", color: "text-orange-500" },
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
              ...
              {brands.slice(0, 5).map((b) => (
                <div key={b.id} className="flex items-center gap-3 px-5 py-3 hover:bg-gray-50/50 transition-colors">
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <p className="text-[11px] text-gray-400 truncate">상담상품 {b._count.products}개</p>
                  </div>
        ...
        <div className="bg-white rounded-xl border border-gray-100 overflow-hidden">
          <div className="flex items-center justify-between px-5 py-3.5 border-b border-gray-50">
            <h2 className="text-sm font-bold text-gray-900">소속 상담사</h2>
          ...
          {sellers.length > 0 ? (
            ...
            <div className="text-center py-10">
              ...
              <p className="text-xs text-gray-400 mb-1">소속 상담사가 없습니다.</p>
              <Link href="/middle/sellers" className="text-xs text-blue-500 hover:underline">상담사 등록하기</Link>
            </div>
          )}
        </div>
      </div>
      ...
      <div>
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 gap-2 sm:gap-3">
          {[
            ...
            { href: "/middle/sellers", label: "상담사 관리", icon: "Store", desc: "상담사 등록 & 조회" },
