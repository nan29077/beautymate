...
export async function POST() {
  ...
  if (existing1) {
    errors.push(`뷰티 전문가 계정 이미 존재: ${consultantEmail}`);
  } else {
      ...
      data: {
        ...
        sellerProfile: {
          create: {
            ...
            shopName: "테스트 뷰티상담소",
            shopDescription: "테스트용 뷰티 전문가 계정입니다.",
            category: "뷰티",
            isApproved: true,
    ...
    results.push(`뷰티 전문가 계정 생성: ${consultant.email} (비밀번호: Test1234!)`);
  }
