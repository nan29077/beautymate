...
async function main() {
  ...
  const seller1User = await prisma.user.create({
    data: {
      email: "seller1@sellerbricks.com",
      name: "김하늘",
      password: pw,
      role: Role.SELLER,
      sellerProfile: {
  ...
  const seller2User = await prisma.user.create({
    data: {
      email: "seller2@sellerbricks.com",
      name: "이수아",
      password: pw,
      role: Role.SELLER,
      sellerProfile: {
  ...
  const seller3User = await prisma.user.create({
    data: {
      email: "seller3@sellerbricks.com",
      name: "박지은",
      password: pw,
      role: Role.SELLER,
      sellerProfile: {
  ...
  const seller4User = await prisma.user.create({
    data: {
      email: "seller4@sellerbricks.com",
      name: "김혜선",
      password: pw,
      role: Role.SELLER,
      sellerProfile: {
  ...
  console.log("  - 관리자: admin@sellerbricks.com / password123");
  console.log("  - 브랜드1: brand1@sellerbricks.com / password123");
  console.log("  - 브랜드2: brand2@sellerbricks.com / password123");
  console.log("  - 셀러1: seller1@sellerbricks.com / password123 (하늘 Pick)");
  console.log("  - 셀러2: seller2@sellerbricks.com / password123 (수아 뷰티랩)");
  console.log("  - 셀러3: seller3@sellerbricks.com / password123 (지은의 라이프로그)");
  console.log("  - 셀러4: seller4@sellerbricks.com / password123 (혜선 Picks, 수수료율 7%)");
