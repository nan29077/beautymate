...
const NODES = [
  { email: "node@sellerbricks.kr",  password: "Node1234!", name: "노드관리A" },
  { email: "node2@sellerbricks.kr", password: "Node1234!", name: "노드관리B" },
];

const MIDDLES = [
  { email: "middle1@sellerbricks.kr", password: "Middle1234!", name: "중간관리자1", nodeIdx: 0 },
  { email: "middle2@sellerbricks.kr", password: "Middle1234!", name: "중간관리자2", nodeIdx: 0 },
  { email: "middle3@sellerbricks.kr", password: "Middle1234!", name: "중간관리자3", nodeIdx: 0 },
  { email: "middle4@sellerbricks.kr", password: "Middle1234!", name: "중간관리자4", nodeIdx: 1 },
  { email: "middle5@sellerbricks.kr", password: "Middle1234!", name: "중간관리자5", nodeIdx: 1 },
];
